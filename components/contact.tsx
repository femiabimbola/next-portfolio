...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      <p className="text-gray-700 -mt-4 dark:text-white/60">
      ...
      >
        <input
          className="h-14 rounded-lg px-4 border border-black/10 dark:bg-white dark:bg-opacity-80 dark:focus:bg-opacity-100 transition-all dark:outline-none"
          type="email"
          name="senderEmail"
          required
          maxLength={300}
